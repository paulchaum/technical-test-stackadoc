# Test Technique de Scraping (Stackadoc)
...
Le candidat devra utiliser le repository Github fourni pour faire un fork **privé** et y ajouter son code.
...
# Scraping Technical Test (Stackadoc)
...
The candidate will have to use the Github repository provided to make a **private** fork and add his code.
